...
import 'package:cryptonic/src/utils/resources/enums/preview_interval_days_enum.dart';
import 'package:cryptonic/src/utils/resources/enums/preview_interval_type_enum.dart';
import 'package:cryptonic/src/presentation/widgets/crypto_list_item_widget.dart';
import 'package:cryptonic/src/presentation/widgets/custom_line_chart_widget.dart';
import 'package:cryptonic/src/presentation/widgets/on_error_widget.dart';
  ...
  void _callPreviewData(CryptoModel cryptoModel) {
    context.read<CryptoPreviewBloc>().add(
          OnPreview(
            ...
            currency: _initialDropValue ?? vsCurrencyList.first,
